	...
	<div class="product-master-wrapper">
		<div class="product-main-wrapper wrap">
			...
			<div class="row featured-extra-images">
				<div class="col s3"><img src="http://dev/wp-content/uploads/2017/02/icon1.jpg"></div>
				<div class="col s3"><img src="http://dev/wp-content/uploads/2017/02/icon2.jpg"></div>
				<div class="col s3"><img src="http://dev/wp-content/uploads/2017/02/icon3.jpg"></div>
				<div class="col s3"><img src="http://dev/wp-content/uploads/2017/02/icon4.jpg"></div>
			</div>
			...
			<div class="row wrap">
				<div class="col s12 m12 l8">
					...
					<div id="features" class="info-panel-to-show">
						<img src="http://dev/wp-content/uploads/2017/02/head.gif" class="responsive-img">
					</div>
				...
				<div class="col s12 m12 l4">
					<div class="product-video-wrap">
						<div>
							<img src="http://dev/wp-content/uploads/2017/02/Screen-Shot-2017-02-23-at-10.47.51-PM.png">
						</div>
						<div>
							<img src="http://dev/wp-content/uploads/2017/02/Screen-Shot-2017-02-23-at-10.48.04-PM.png">
						</div>
					</div>
				</div>
			</div>
